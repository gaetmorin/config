...
hi StatusLineNC guifg=#777777 guibg=#E0EAF5 gui=none
...
hi SpecialKey	guifg=#777777 guibg=NONE gui=italic,bold

" Syntax highlighting
hi Comment 		guifg=#999999 guibg=NONE gui=italic
hi Todo 		guifg=#999999 guibg=NONE gui=italic,bold
...
hi Keyword		guifg=#428BCA guibg=NONE gui=none
hi Statement 	guifg=#428BCA guibg=NONE gui=none
hi PreProc 		guifg=#428BCA guibg=NONE gui=none
hi StorageClass guifg=#428BCA guibg=NONE gui=none
hi Structure    guifg=#428BCA guibg=NONE gui=none
hi Typedef      guifg=#428BCA guibg=NONE gui=none
